...
RUN wget -q https://github.com/odewahn/httpServe/releases/download/0.0.3/httpServe-0.0.3-linux-amd64
RUN mv httpServe-0.0.3-linux-amd64 /usr/local/bin/httpServe
